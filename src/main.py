...
from config import DATA_DIR, REPORTS_DIR, logger, RIGHT_FACING_LANDMARKS
from utils import validate_directory, validate_file
...
class PoseVideoProcessor:
    ...
    def process_video(self, input_path: Path, output_path: Path) -> None:
        ...
        frame_number = 0
        pose_data = []  # List to store pose data for JSON output.
        ...
        with self.mp_pose.Pose(min_detection_confidence=self.min_detection_confidence,
            ...
            while cap.isOpened():
                ...
                if results.pose_landmarks:
                    ...
                    # Draw additional line between EarL and ShoulderL.
